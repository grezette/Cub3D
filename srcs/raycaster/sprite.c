...
/*   Updated: 2020/07/31 16:54:04 by grezette         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
void	ft_set_cal_sprite(t_cub *cub, int i)
{
	...
	cub->spt_drawend.x = (cub->spt_drawend.x >= cub->reso.x) ? cub->reso.x - 1 : cub->spt_drawend.x;
}
...
void	ft_sprite_casting(t_cub *cub)
{
	...
	while (++i < cub->nb_sprt)
	{
		...
		//printf("%d | %d | %d |%d\n", cub->spt_drawstart.x, cub->spt_drawstart.y, cub->spt_drawend.x, cub->spt_drawend.y);
